...
contract Bug {
    uint public w = 5;
    uint public immutable v = set(); // Initialize from function (sets to 77)
    uint public immutable x = set(); // Initialize from function (sets to 88)
    address payable public owner; // changed to address payable
