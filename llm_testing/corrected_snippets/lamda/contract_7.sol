...
contract Bug {
    uint public w = 5;
    uint256 private v = 77; // Initialize from constructor
    uint256 private x = 88; // Initialize from constructor
    address payable private owner; // changed to address payable
